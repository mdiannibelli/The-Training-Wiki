...
export default function Isquiotibiales() {
  return (
    <>
        ...
        <div className='contenedor-ejercicios'>
            ...
            <div className='ejercicio'>
                <h2>Máquina de femorales</h2>
                <hr className='bar-separate'/>
                <h3>Dificultad: Principiante</h3>
                <div className='image-exercise'>
                    <ReactPlayer
                        url={'https://media.musclewiki.com/media/uploads/videos/branded/male-machine-hamstring-curl-front.mp4#t=0.1'}
                        width='100%'
                        height='100%'
                        volume='0.1'
                        muted
                        ...
                        />
                    <ReactPlayer
                        url={'https://media.musclewiki.com/media/uploads/videos/branded/male-machine-hamstring-curl-side.mp4#t=0.1'}
                        width='100%'
                        height='100%'
                        volume='0.1'
                        muted
                ...
                <ol className='instrucciones-ejercicio'>
                    <li>Túmbate en la máquina, colocando las piernas debajo de la palanca acolchada. Coloque las piernas de modo que la palanca acolchada quede debajo de los músculos de la pantorrilla.</li>
                    <li>Apóyese agarrando las manijas laterales de la máquina y levante lentamente el peso con las piernas, con los dedos de los pies apuntando rectos.</li>
                    <li>Haga una pausa en la cúspide del movimiento y luego regrese lentamente a la posición inicial.</li>
